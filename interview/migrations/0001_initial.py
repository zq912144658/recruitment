# Generated by Django 3.1.4 on 2020-12-03 12:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=135, max_length=135, verbose_name='邮箱')),
                ...
                ('candidate', models.CharField(blank=True, max_length=135, verbose_name='候选人信息备注')),
                ...
                ('degree', models.CharField(blank=True, choices=[('本科', '本科'), ('硕士', '硕士'), ('硕士', '硕士')], max_length=135, verbose_name='学历')),
                ...
                ('second_learing_adility', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='学习能力得分')),
                ('second_professional_conptetency', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='专业能力得分')),
                ('second_pursue_of_excellence', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='追求卓越得分')),
                ('second_communication_abillty', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='沟通能力得分')),
                ...
                ('created_date', models.DateTimeField(blank=True, max_length=256, verbose_name='创建时间')),
                ('modified_date', models.DateTimeField(blank=True, max_length=256, verbose_name='更新时间')),
