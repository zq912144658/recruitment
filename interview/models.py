...
#候选人学历
DEGREE_TYPE = ((u'本科',u'本科'),(u'硕士',u'硕士'),(u'硕士',u'硕士'))
#第一轮面试结果
FIRST_INTERVIEW_TYPE = ((u'建议复试',u'建议复试'),(u'待定',u'待定'),(u'放弃',u'放弃'))
#HR终面结论
...
class Candidate(models.Model):
	...
	first_result = models.CharField(max_length=256,choices=FIRST_INTERVIEW_TYPE,blank=True,verbose_name=u'初试结果')
	...
	second_learing_adility = models.DecimalField(decimal_places=1,null=True,max_digits=2,blank=True,verbose_name=u'学习能力得分')
	
	second_professional_conptetency = models.DecimalField(decimal_places=1,null=True,max_digits=2,blank=True,verbose_name=u'专业能力得分')
	second_pursue_of_excellence = models.DecimalField(decimal_places=1,null=True,max_digits=2,blank=True,verbose_name=u'追求卓越得分')
	second_communication_abillty = models.DecimalField(decimal_places=1,null=True,max_digits=2,blank=True,verbose_name=u'沟通能力得分')
	...
	second_result = models.CharField(max_length=256,choices=FIRST_INTERVIEW_TYPE,blank=True,verbose_name=u'专业复试结果')
